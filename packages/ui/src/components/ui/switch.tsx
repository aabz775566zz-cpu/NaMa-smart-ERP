...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        // translate-x is a physical transform, not a logical property — it
        // does not auto-flip for RTL the way margin/padding/inset do, so
        // the rtl: variant is required here explicitly.
